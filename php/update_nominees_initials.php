...
$count = sizeof($query_committeedetails);
...
$query_votercount = ($crud->getData("SELECT * FROM election_keys WHERE election_id='$election_id'"));
//$count = $query_electiondetails[0]['committee_count'];
$voter_count = sizeof($query_votercount);
